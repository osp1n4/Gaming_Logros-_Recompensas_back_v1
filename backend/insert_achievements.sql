...
VALUES 
  ...
  ('MONSTER_SLAYER', 'achievement.monster_slayer.title', 'achievement.monster_slayer.desc', 10, 'MONSTER_KILLED', true),
  ('HUNDRED_KILLS', 'achievement.hundred_kills.title', 'achievement.hundred_kills.desc', 100, 'MONSTER_KILLED', true),
  ('THOUSAND_KILLS', 'achievement.thousand_kills.title', 'achievement.thousand_kills.desc', 1000, 'MONSTER_KILLED', true),
  ...
  ('ULTIMATE_CHAMPION', 'achievement.ultimate_champion.title', 'achievement.ultimate_champion.desc', 5000, 'MONSTER_KILLED', true);
