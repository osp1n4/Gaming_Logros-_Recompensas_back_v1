...
VALUES
  ...
  (gen_random_uuid(), 'MONSTER_SLAYER_10', 'achievement.monster_slayer_10.title', 'achievement.monster_slayer_10.description', 10, 'MONSTER_KILLED', FALSE, NULL, NULL, TRUE, NOW(), NOW()),
  (gen_random_uuid(), 'MONSTER_SLAYER_50', 'achievement.monster_slayer_50.title', 'achievement.monster_slayer_50.description', 50, 'MONSTER_KILLED', FALSE, NULL, NULL, TRUE, NOW(), NOW()),
  (gen_random_uuid(), 'MONSTER_SLAYER_100', 'achievement.monster_slayer_100.title', 'achievement.monster_slayer_100.description', 100, 'MONSTER_KILLED', FALSE, NULL, NULL, TRUE, NOW(), NOW()),
  ...
  (gen_random_uuid(), 'LEGENDARY_HUNTER', 'achievement.legendary_hunter.title', 'achievement.legendary_hunter.description', 500, 'MONSTER_KILLED', FALSE, NULL, NULL, TRUE, NOW(), NOW())
